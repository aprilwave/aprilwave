        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-12">
              Whether you need an original score for your next film, impactful
              sound design for a game, or just want to collaborate on a
              track—I'm ready to listen.
            </p>
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:hello@aprilwave.com"
          ...
          <motion.div
            ...
            className="glass-panel p-6 lg:p-8 md:p-10 rounded-3xl relative overflow-hidden"
          >
