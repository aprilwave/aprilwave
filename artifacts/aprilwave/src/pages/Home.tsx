      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full flex flex-col items-center text-center">
          ...
          <motion.p
            ...
            className="text-xs md:text-sm text-muted-foreground mb-10 leading-relaxed tracking-widest uppercase"
          >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-panel text-sm font-medium mb-10 text-foreground/80"
          >
